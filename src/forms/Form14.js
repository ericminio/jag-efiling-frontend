...
import Form14Preview from "../components/Form14Preview";
...
class Form14 extends Component {
          ...
          <div id="topicTemplate" className="template container gov-container form" ref={ (element)=> {this.element = element }}>
            ...
            <div id="breadcrumbContainer">
                <ol className="breadcrumb">
                    ...
                    <li>
                        <a href="">Certificate of Readiness (Form 14)</a>
                    </li>
                </ol>
            </div>
              ...
              <ProgressStatusBar
                  ...
                  steps={["Access","Form 14","Preview","Payment"]}
              />

            <div className="row">
                <div id="main-content" role="main" className="contentPageMainColumn col-sm-12">
                    <div className="form-title not-printable">
                        <h1>CERTIFICATE OF READINESS</h1>
                        FORM 14 (RULES 28 (3) AND (4))
                    </div>

                    <div className="form-section not-printable">
                      <h2 style={{ fontWeight:'bold' }}>When Do You Use the Certificate of Readiness (Form 14)?</h2>
                      <p>
                        A certificate of readiness tells the court registry that you are ready to schedule the appeal hearing.
                        After you have filed the appeal record, your factum, and the appeal book, your final step is to file a certificate of readiness.
                      </p>
                    </div>
